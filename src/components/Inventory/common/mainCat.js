...
// export default function MainCatTable() {
//   const dispatch = useDispatch();
//   const { mainCategories, loading, error } = useSelector(
...
//     const matchesSearch =
//       c.Main_CatName.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       c.Main_CatID.toLowerCase().includes(searchTerm.toLowerCase());

//     if (activeFilter === "all") return matchesSearch;
//     if (activeFilter === "active") return matchesSearch && c.Main_CatStatus === "A";
//     if (activeFilter === "inactive") return matchesSearch && c.Main_CatStatus !== "A";
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <p className="text-gray-500 dark:text-gray-400 text-sm">Active Categories</p>
//                 <p className="text-2xl font-bold text-green-600 dark:text-green-400">
//                   {mainCategories.filter((c) => c.Main_CatStatus === "A").length}
//                 </p>
//               </div>
...
//                           <button
//                             onClick={() =>
//                               dispatch(openModal("UPDATE_MAIN_CATEGORY", { mainCategory }))
//                             }
